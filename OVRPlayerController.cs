...
public class OVRPlayerController : MonoBehaviour
{
	...
	private float RotationScaleMultiplier = 0.8f;
    ...
    public GameObject flashLightLeft = null;
    public GameObject flashLightRight = null;
    ...
    void Update()
	{
        ...
        if (ControllerIsConnected)
        {
            ...
            if (OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger))
            {
                ...
                {
                    flashLightLeft.transform.GetChild(0).GetComponent<Light>().enabled = !flashLightLeft.transform.GetChild(0).GetComponent<Light>().enabled;
                }

                if (flashLightRight != null)
                {
                    flashLightRight.transform.GetChild(0).GetComponent<Light>().enabled = !flashLightRight.transform.GetChild(0).GetComponent<Light>().enabled;
                }
            }
        }
    }
	...
	public virtual void UpdateMovement()
	{
		...
		if (EnableLinearMovement)
		{
            ...
            {
                secondaryAxis = OVRInput.Get(OVRInput.Axis2D.PrimaryTouchpad);
                if (secondaryAxis.x < 0.45 && secondaryAxis.x > -0.45)
                {
                    secondaryAxis.x = 0f;
                    moveInfluence *= 2.0f;
                }
		...
		/*if (EnableRotation)
		{
			...
			else
			{
                ...
                secondaryAxis = OVRInput.Get(OVRInput.Axis2D.PrimaryTouchpad);
                if (secondaryAxis.x < 0.35 && secondaryAxis.x > -0.35)
                {
                    secondaryAxis.x = 0f;
                }
